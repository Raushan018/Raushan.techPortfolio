    ...
    <div className="github-repo-card">
      <div className="card">
        <div className="content">
          ...
          <div className="front" onClick={() => openUrlInNewTab(repo.node.url, repo.node.name)}>
            <div className="img">
            ...
            <div className="front-content">
              {repo.node.primaryLanguage !== null && (
                <small className="badge">{repo.node.primaryLanguage.name}</small>
              )}
              <div className="description">
                ...
                <p className="card-footer">
                  ⭐ {repo.node.stargazers.totalCount} &nbsp; | &nbsp; 🍴 {repo.node.forkCount}
                </p>
              </div>
            </div>
          </div>
